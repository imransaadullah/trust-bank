...
// SERVICE_CREDENTIAL_MODEL.md (repo root). High-entropy random tokens
// don't need slow/salted password hashing — SHA-256 is what
// Stripe/GitHub use for the same reason.
const crypto = require('crypto');
const prisma = require('../db/prismaClient');
const { CredentialNotFoundError } = require('../utils/errors');

const TOKEN_PREFIX_LABEL = 'cko_live_';
