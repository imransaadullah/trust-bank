...
router.post('/:tenantId/compliance/kyc-tier-check', auth,
  proxyRoute('compliance', 'POST', (req) => `/v1/tenants/${req.params.tenantId}/compliance/kyc-tier-check`));

router.post('/:tenantId/compliance/device-check', auth,
  proxyRoute('compliance', 'POST', (req) => `/v1/tenants/${req.params.tenantId}/compliance/device-check`));
