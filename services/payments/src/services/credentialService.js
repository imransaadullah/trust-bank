// Replaces the single static PAYMENTS_SHARED_SECRET with scoped,
...
const TOKEN_PREFIX_LABEL = 'pay_live_';
...
async function issue({ tenantId, label, scope }) {
  ...
  // The only place the plaintext token ever exists after this call
  // returns — it is not retrievable again.
